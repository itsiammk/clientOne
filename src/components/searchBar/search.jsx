...
const SearchBar = ({handleRoute, handleKeyPress, handleChange}) => {
  return (
    <div className={styles.searchBox}> {/* Use className with styles.searchBox */}
      <input className={styles.searchInput} type="text" placeholder="Search something"  onChange={handleChange} onKeyPress={handleKeyPress}/>
      <button className={styles.searchButton} onClick={handleRoute}>
